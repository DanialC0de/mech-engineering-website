...
urlpatterns = [
    ...
    # ✅ مسیرهای API (بدون تکرار panel/professor)
    path('api/dashboard/', views.get_dashboard_data, name='dashboard_data'),
    path('api/invitations/', views.get_invitations_list, name='invitations_list'),
    path('api/invitations/<int:invitation_id>/respond/', views.respond_to_invitation, name='respond_invitation'),
    path('api/admin/send-invitation/', views.send_event_invitation, name='send_event_invitation'),
    path('api/events/', views.get_events_list, name='events_list'),
    path('api/events/propose/', views.propose_event, name='propose_event'),
    ...
    path('api/articles/upload/', views.create_article, name='upload_article'),
    path('api/articles/<int:article_id>/delete/', views.delete_article, name='delete_article'),
